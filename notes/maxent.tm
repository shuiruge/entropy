...
<\body>
  ...
  where the notation <math|<around*|\<langle\>|\<cdots\>|\<rangle\>><rsub|p>\<assign\><big|int><rsub|\<cal-X\>>\<mathd\>x
  ...
  <\equation>
    ...
    p<around*|(|x|)>ln<frac|p<around*|(|x|)>|q<around*|(|x|)>>+\<theta\><rsup|\<alpha\>><around*|(|<big|int><rsub|\<cal-X\>>\<mathd\>x
  ...
  <\align>
    <tformat|<table|<row|<cell|<frac|\<delta\>L|\<delta\>p<around*|(|x|)>><around*|[|p,\<theta\>,\<mu\>|]>=>|<cell|-ln
    p<around*|(|x|)>-1+ln q<around*|(|x|)>+\<theta\><rsup|\<alpha\>>
    f<rsub|\<alpha\>><around*|(|x|)>+\<mu\>;>>|<row|<cell|<frac|\<partial\>L|\<partial\>\<theta\><rsup|\<alpha\>>><around*|[|p,\<theta\>,\<mu\>|]>=>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
    p<around*|(|x|)>f<rsub|\<alpha\>><around*|(|x|)>-<wide|f|\<bar\>><rsub|\<alpha\>>;>>|<row|<cell|<frac|\<partial\>L|\<partial\>\<mu\>><around*|[|p,\<theta\>,\<mu\>|]>=>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
    p<around*|(|x|)>-1.>>>>
  </align>

  These equations shall vanish on extremum. If
  <math|<around*|(|p<rsub|\<star\>>,\<theta\><rsub|\<star\>>,\<mu\><rsub|\<star\>>|)>>
  is an extremum, then we shall have

  <\equation>
    <frac|\<partial\>ln Z|\<partial\>\<theta\><rsup|\<alpha\>>><around*|(|\<theta\><rsub|\<star\>>|)>=<wide|f|\<bar\>><rsub|\<alpha\>>
  </equation>
  ...
  <\equation>
    ...
    q<around*|(|x|)> exp<around*|(|\<theta\><rsup|\<alpha\>>
  ...
  <\equation>
    p<rsub|\<star\>><around*|(|x|)>=p<around*|(|x,\<theta\><rsub|\<star\>>|)>,
  </equation>
