...
<\body>
  ...
  which is non-positive. So, the sign of <math|H<around*|(|P<around*|(|t+\<Delta\>t|)>,\<Pi\>|)>-H<around*|(|P<around*|(|t|)>,\<Pi\>|)>>
  ...
  find<\footnote>
    ...
    <\equation*>
      ...
      p<rsup|-1><around*|(|x,t|)> r<around*|(|x,y|)> p<around*|(|y,t|)>
      r<around*|(|x,z|)> p<around*|(|z,t|)>+\<omicron\><around*|(|\<Delta\>t<rsup|2>|)>.
    </equation*>

    We shall replace <math|p<around*|(|\<cdummy\>,t|)>> by
    <math|f<around*|(|\<cdummy\>|)>=p<around*|(|\<cdummy\>,t|)>/\<pi\><around*|(|\<cdummy\>|)>>
    as above, and equip the factor <math|r<around*|(|x,y|)>
    \<pi\><around*|(|y|)>>. So, using detailed balance condition, we have

    <\align>
      <tformat|<table|<row|<cell|>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
      <big|int><rsub|\<cal-X\>>\<mathd\>y<big|int><rsub|\<cal-X\>>\<mathd\>z
      p<rsup|-1><around*|(|x,t|)> r<around*|(|x,y|)> p<around*|(|y,t|)>
      r<around*|(|x,z|)> p<around*|(|z,t|)>>>|<row|<cell|<around*|{|f\<assign\>\<cdots\>|}>=>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
      <big|int><rsub|\<cal-X\>>\<mathd\>y<big|int><rsub|\<cal-X\>>\<mathd\>z
      \ r<around*|(|x,y|)> <with|color|dark blue|r<around*|(|x,z|)>>
      <frac|1|f<around*|(|x|)> \<pi\><around*|(|x|)>> f<around*|(|y|)>
      \<pi\><around*|(|y|)>f<around*|(|z|)> <with|color|dark
      blue|\<pi\><around*|(|z|)>>>>|<row|<cell|<around*|{|detailed
      balance|}>=>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
      <big|int><rsub|\<cal-X\>>\<mathd\>y<big|int><rsub|\<cal-X\>>\<mathd\>z
      \ r<around*|(|x,y|)> \<pi\><around*|(|y|)> r<around*|(|z,x|)>
      \<pi\><around*|(|x|)> <frac|1|f<around*|(|x|)> \<pi\><around*|(|x|)>>
      f<around*|(|y|)>f<around*|(|z|)>>>|<row|<cell|=>|<cell|<big|int><rsub|\<cal-X\>>\<mathd\>x
      <big|int><rsub|\<cal-X\>>\<mathd\>y \ r<around*|(|x,y|)>
      \<pi\><around*|(|y|)> <frac|f<around*|(|y|)>|f<around*|(|x|)>><around*|[|<big|int><rsub|\<cal-X\>>\<mathd\>z
      r<around*|(|z,x|)> f<around*|(|z|)>|]>.>>>>
    </align>

    In the case when <math|f> is constant, the factor
    <math|<big|int><rsub|\<cal-X\>>\<mathd\>z r<around*|(|z,x|)>
    f<around*|(|z|)>=f<around*|(|0|)> <big|int><rsub|\<cal-X\>>\<mathd\>z
    r<around*|(|z,x|)>=0>, where we have used the \Pnormalization condition\Q
    <math|<big|int><rsub|\<cal-X\>>\<mathd\>z r<around*|(|z,x|)>=0>.<math|>
  </footnote>
  ...
  (Taylor expanding the <math|q<rsub|\<Delta\>t><around*|(|x\|y|)>> in
  <math|K<around*|(|x,y|)>> gives an extra term

  <\equation*>
    <frac|\<Delta\>t|2><big|int><rsub|\<cal-X\>>\<mathd\>x
    <big|int><rsub|\<cal-X\>>\<mathd\>y \ \<delta\><around*|(|x-y|)>
    \<pi\><around*|(|y|)> <frac|f<around*|(|y|)>|f<around*|(|x|)>><around*|[|<big|int><rsub|\<cal-X\>>\<mathd\>z
    r<around*|(|z,x|)> f<around*|(|z|)>|]>,
  </equation*>

  which is zero. Indeed, integrating over <math|y>, it becomes (omitting the
  constant factor) <math|<big|int><rsub|\<cal-X\>>\<mathd\>x<big|int><rsub|\<cal-X\>>\<mathd\>z
  r<around*|(|z,x|)> \<pi\><around*|(|x|)> f<around*|(|z|)>>; then by
  inserting detailed balance condition, it turns to be
  <math|<big|int><rsub|\<cal-X\>>\<mathd\>z
  <around*|[|<big|int><rsub|\<cal-X\>>\<mathd\>x r<around*|(|x,z|)>|]>
  \<pi\><around*|(|z|)> f<around*|(|z|)>> where the
  <math|<around*|[|\<cdots\>|]>=0>.) When <math|f> is constant,
  <math|<big|int><rsub|\<cal-X\>>\<mathd\>z r<around*|(|z,x|)>=0> gives
  <math|I=0>. Altogether, we arrive at
  ...
  <\small>
    <\equation*>
      ...
      r<around*|(|z,x|)> f<around*|(|z|)>|]>-<around*|[|f<around*|(|x|)>-f<around*|(|y|)>|]><around*|[|ln
  ...
  <math|P<around*|(|t|)>> has been close to <math|\<Pi\>>.
...
<\references>
  <\collection>
    ...
    <associate|equation:circle|<tuple|11|9>>
    <associate|equation:define stationary density function|<tuple|10|9>>
    ...
    <associate|equation:metropolis-hastings origin|<tuple|13|10>>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      Transition Density Is Necessary to Ensure Relaxation (TODO)
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
